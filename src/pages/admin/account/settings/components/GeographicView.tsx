...
class GeographicView extends Component<GeographicViewProps> {
  componentDidMount = () => {
    ...
    if (dispatch) {
      dispatch({
        type: 'adminAndaccountAndsettings/fetchProvince',
      });
    }
  };
  ...
  componentDidUpdate(props: GeographicViewProps) {
    ...
    if (!props.value && !!value && !!value.province) {
      if (dispatch) {
        dispatch({
          type: 'adminAndaccountAndsettings/fetchCity',
...
export default connect(
  ({
    ...
    const { province, city } = adminAndaccountAndsettings;
    return {
      province,
      city,
      loading: loading.models.adminAndaccountAndsettings,
    };
  },
)(GeographicView);
