...
class Center extends PureComponent<CenterProps, CenterState> {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'adminAndaccountAndcenter/fetchCurrent',
    });
    dispatch({
      type: 'adminAndaccountAndcenter/fetch',
    });
  }
...
export default connect(
  ({
    loading,
    adminAndaccountAndcenter,
  }: {
    loading: { effects: { [key: string]: boolean } };
    adminAndaccountAndcenter: ModalState;
  }) => ({
    currentUser: adminAndaccountAndcenter.currentUser,
    currentUserLoading: loading.effects['adminAndaccountAndcenter/fetchCurrent'],
  }),
)(Center);
